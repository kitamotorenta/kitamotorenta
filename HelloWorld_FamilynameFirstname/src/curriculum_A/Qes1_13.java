...
public class Qes1_13 {
	...
	//問７ 作成した自己紹介に続いてBMIが出力されるようにしてください
	double BMI = 1.7;
	...
	System.out.println("\r\n");
	System.out.println("「初めまして" +name + "です」");
	System.out.println("「年齢は" +( old*2) + "歳です」");
	...
	//過去の年齢
	String old1 =Integer.toString(old);
	//過去の身長
	...
	//コンソールに出力
	System.out.println("\r\n");
	System.out.println(old2+height2);
	
	
	//問13　問12で変換した【年齢・身長】で【年齢が25もしくは身長が160以上】であればtrueを出力してください
	terms=(old2==25)||(height2>=160);
